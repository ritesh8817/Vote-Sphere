<?php
	...
	while($row = $query->fetch_assoc()){
		...
		while($crow = $cquery->fetch_assoc()){
			...
			$candidate .= '
				<li>
					'.$input.'<button class="btn btn-primary btn-sm btn-curve clist" style="background-color: #4682B4 ;color:black ; font-size: 12px; font-family:Times"><i class="fa fa-search"></i> Description</button><img src="'.$image.'" height="100px" width="100px" class="clist"><span class="cname clist">'.$crow['firstname'].' '.$crow['lastname'].'</span>
				</li>
			';
		}
				...
				<div class="col-xs-12">
					<div class="box box-solid"style="background-color: #d3deff" id="'.$row['id'].'">
						<div class="box-header with-border" style="background-color: #d3deff">
							<h3 class="box-title"><b style="color:white">'.$row['description'].'</b></h3>
