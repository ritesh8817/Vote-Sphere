...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="background-color:#e1f6ff ">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12" >
          <div class="box" style="background-color: #d3deff">
                      ...
                      echo "
                        <tr style='color:black ; font-size: 15px; font-family:Times'>
                         ...
                         <td>".$row['lastname']."</td>
                          ...
                          <td>
                            <a href='#edit_photo' data-toggle='modal' class=' photo' data-id='".$row['id']."'><span class='fa fa-edit'></span></a>

                            <img src='".$image."' width='30px' height='30px' style='border-radius: 5px;'>
                          </td>
                          <td>".$row['voters_id']."</td>
                          <td>
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      $('#positions').find('option[value='+response.positions+'] ').attr('selected','select');
