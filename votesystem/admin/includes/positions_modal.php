    ...
    <div class="modal-dialog" >
        <div class="modal-content" style="background-color: #d3deff ;color:black ; font-size: 15px; font-family:Times ">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-danger btn-curve pull-left"style='  color:black ; font-size: 12px; font-family:Times'  data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
