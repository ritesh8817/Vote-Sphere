...
<div class="wrapper">
	...
	<?php include 'includes/navbar.php'; ?>
	  ...
	  <div class="content-wrapper" style="background-color: #e1f6ff ">
	    <div class="container" style="background-color: #e1f6ff ">
			        	...
			        	<span class="message"></span>
						    ...
						    <form method="POST" id="ballotForm" action="submit_ballot.php">
				        		<?php
				        			...
				        			$candidate = '';
									$voter_sql = "SELECT positions from voters where id=".$voter['id'];
									$voters_res = $conn->query($voter_sql);
									$pos_id = 0;
									while($row = $voters_res->fetch_assoc()){
										if($row['positions'] != ''){
										$pos_id = $row['positions'];
										}
									}

				        			$sql = "SELECT * FROM positions  WHERE id=".$pos_id." ORDER BY priority ASC ";
									$query = $conn->query($sql);
									while($row = $query->fetch_assoc()){
										$vote_sql = "SELECT * FROM votes WHERE voters_id = '".$voter['id']."' and position_id='".$row['id']."'";
										$vquery = $conn->query($vote_sql);
										if($vquery->num_rows > 0){
											?>
											<div class="text-center" style="padding:50px;color:black ; font-size: 35px; font-family:Times" >
											...
											echo '
												<div class="row">
													<div class="col-xs-12">
														<div class="box box-solid" style="background-color: #d3deff" id="'.$row['id'].'">
															<div class="box-header with-border" style="background-color: #d3deff">
